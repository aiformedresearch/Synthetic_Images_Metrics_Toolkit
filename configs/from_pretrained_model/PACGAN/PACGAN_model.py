...
class WSConv2d(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size=3, stride=1, padding=1, gain=2):
        super().__init__()
        self.conv = nn.Conv2d(in_channels, out_channels, kernel_size, stride, padding).to(device='cuda')
...
class Generator(nn.Module):
    def __init__(
        ...
        self.label_embedding = nn.Embedding(class_size, embedding_dim).to(device='cuda')
