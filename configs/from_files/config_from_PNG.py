...
DATASET = {
    ...
    "class": "<defined below: PNGDataset>",

    # Additional parameters required for loading the dataset.
    "params": 
    {
        # Path to the dataset file containing the real images (in PNG format).
...
DATASET["class"] = PNGDataset
SYNTHETIC_DATA["from_files"]["class"] = PNGDataset
