...
def calc_metrics(ctx, network_pkl, metrics, data, labels, mirror, gpus, verbose, run_dir, oc_detector_path):
    ...
    \b 
      Extra metrics:
        ...
        prdc50k    Precision, recall, density and coverage against 50k real images.
    ...
    if data is not None:
        args.dataset_kwargs = dnnlib.EasyDict(class_name='training.dataset_NIfTI.ImageFolderDataset', path=data, path_labels=labels)
